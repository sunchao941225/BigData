...
public class App {
    ...
    public void getClient() {
        ...
        client = CuratorFrameworkFactory.newClient("192.168.11.31:2181,192.168.11.32:2181,192.168.11.33:2181", retry);
    ...
    public void setNode() throws Exception {
        client.setData().forPath("/baizhi/1", "4561QWEQWEQWEQWE".getBytes());
    ...
    public void delNode() throws Exception {
        ...
        client.delete().deletingChildrenIfNeeded().forPath("/baizhi/1");
