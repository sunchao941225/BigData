...
public class JobRunner {
    public static void main(String[] args) throws Exception {
        ...
        TextInputFormat.setInputPaths(job, new Path("G:\\Note\\Day02-Hadoop\\作业\\数据\\log.txt"));
        ...
        TextOutputFormat.setOutputPath(job, new Path("G:\\Note\\Day02-Hadoop\\作业\\数据\\out1"));
